...
## 3-2. 기타
* [stackoverflow, Fluter setState() make a loop to be always recalled](https://stackoverflow.com/questions/52070959/fluter-setstate-make-a-loop-to-be-always-recalled)  
