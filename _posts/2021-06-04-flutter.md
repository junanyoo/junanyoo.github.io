...
class _LoginState extends State<Login> with TickerProviderStateMixin {
  ...
  late final AnimationController _controllerProverb = AnimationController(
    duration: Duration(milliseconds: fadeMillisec),
    vsync: this,
  )..repeat(reverse: false);
  late final Animation<double> _animationProverb = CurvedAnimation(
    parent: _controller,
    curve: Curves.easeIn,
  );
